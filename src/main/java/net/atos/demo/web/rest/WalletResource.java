...
import net.atos.demo.service.WalletService;
...
/**
 * REST controller for managing {@link net.atos.demo.domain.Wallet}.
 */
@RestController
@RequestMapping("/api")
public class WalletResource {
    ...
    public ResponseEntity<Wallet> createWallet(@Valid @RequestBody Wallet wallet) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/wallets/" + result.getUserId()))
    ...
    public ResponseEntity<Wallet> updateWallet(@Valid @RequestBody Wallet wallet) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, wallet.getUserId().toString()))
            .body(result);
    }
